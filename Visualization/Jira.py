...
def pie_chart(series, names, colors,title):
...
plt.savefig('Jira Plots\ issues_Overview.png', format='png',bbox_inches='tight')
plt.close()
...
plt.savefig('Jira Plots\ Top performers.png', format='png', bbox_inches='tight')
plt.close()
...
colors = [cmap(0.6),
          ...
          cmap(0.2),
          '#C3A316']
pie_chart(epic.groupby('Priority').count()['IssueType'], epic.groupby('Priority').count().index, colors,'Epic priority breakdown')
...
epic_estimate.plot(x="IssueKey", y=["AggregateTimeSpent", "OriginalTimeEstimate"], figsize=(50, 15), grid=True,
                   color=["darkgreen", "red"])
plt.suptitle('Underestimated Efforts spent on Epics', fontsize=40)
...
colors = [cmap(0.6),
          ...
          cmap(0.2),
          '#C3A316']
pie_chart(tasks.groupby('Priority').count()['IssueType'], tasks.groupby('Priority').count().index, colors,"Task Priority breakdown")
...
colors = [cmap(1.0),
          ...
          cmap(0.2),
          '#C3A316']
pie_chart(tasks.groupby('Status').count()['IssueType'], tasks.groupby('Status').count().index, colors,'Task status breakdown')
...
task_estimate.plot(x="IssueKey", y=["AggregateTimeSpent", "OriginalTimeEstimate"], figsize=(50, 15), grid=True,
                   color=["darkgreen", "red"])
plt.suptitle('Unerestimated Efforts spent on Tasks', fontsize=40)
plt.ylabel("Time in hours", fontsize=50)
...
colors = [cmap(0.75),
          ...
          cmap(0.4),
          '#C3A316']
pie_chart(sub_task.groupby('Priority').count()['IssueType'], sub_task.groupby('Priority').count().index, colors,'SubTask Priority breakdown')
...
colors = [cmap(1.0),
          ...
          "#C3A316",
          'grey']
pie_chart(sub_task.groupby('Status').count()['IssueType'], sub_task.groupby('Status').count().index, colors,'SubTask status breakdown')
...
colors = [cmap(0.75),
          ...
          cmap(0.4),
          '#C3A316']
pie_chart(stories.groupby('Priority').count()['IssueType'], stories.groupby('Priority').count().index, colors,'Story Priority breakdown')
...
colors = [cmap(1.0),
          ...
          "#C3A316",
          'grey']
pie_chart(stories.groupby('Status').count()['IssueType'], stories.groupby('Status').count().index, colors,'Story status breakdown')
...
story_estimate.plot(x="IssueKey", y=["AggregateTimeSpent", "OriginalTimeEstimate"], figsize=(50, 15), grid=True,
                    color=["darkgreen", "red"])
plt.suptitle('Underestimated Efforts spent on stories', fontsize=40)
plt.ylabel("Time in hours", fontsize=50)
...
colors = [cmap(0.75),
          ...
          cmap(0.4),
          '#C3A316']
pie_chart(Bugs.groupby('Priority').count()['IssueType'], Bugs.groupby('Priority').count().index, colors,'Bug Priority breakdown')
...
colors = [cmap(1.0),
          ...
          "#C3A316",
          'grey']
pie_chart(Bugs.groupby('Status').count()['IssueType'], Bugs.groupby('Status').count().index, colors,'Bug Status breakdown')
...
bug_estimate.plot(x="IssueKey", y=["AggregateTimeSpent", "OriginalTimeEstimate"], figsize=(50, 15), grid=True,
                  color=["darkgreen", "red"])
plt.suptitle('Underestimated Efforts spent on Bugs', fontsize=40)
plt.ylabel("Time in hours", fontsize=50)
...
colors = [cmap(0.75),
          ...
          cmap(0.4),
          '#C3A316']
pie_chart(test_cases.groupby('Priority').count()['IssueType'], test_cases.groupby('Priority').count().index, colors,'Testcase Priority breakdown')
...
colors = [cmap(1.0),
          ...
          "#C3A316",
          'grey']
pie_chart(test_cases.groupby('Status').count()['IssueType'], test_cases.groupby('Status').count().index, colors,'Testcase status breakdown')
...
test_estimate.plot(x="IssueKey", y=["AggregateTimeSpent", "OriginalTimeEstimate"], figsize=(50, 15), grid=True,
                   color=["darkgreen", "red"])
plt.suptitle('Underestimated Efforts spent on Testcases', fontsize=40)
plt.ylabel("Time in hours", fontsize=50)
