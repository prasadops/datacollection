...
date = '/home/saiprasad/workspace/data/Dev_Tool_Data/Weekly_Reports/jan13_jan19_2022/'
...
if len(df) > 0:
    ...
    logging.warning("No data for dashboard")
...
if len(df)>0:
        ...
        plt.savefig('Git Plots\ Sapor_lines.png', format='png', dpi=300, bbox_inches='tight')
        plt.close()
...
if len(df)>0:
    ...
    logging.warning("No data audit client")
...
if len(df)>0:
    ...
    logging.warning("No data for audit service")
...
if len(df)>0:
    ...
    logging.warning("No data for gate")
...
if len(df)>0:
    ...
    logging.warning("No data for oestest")
...
if len(df)>0:
    ...
    logging.warning("No data for UI")
...
if len(df)>0:
    ...
    logging.warning("No data for Platform")
...
if len(df)>0:
    ...
    logging.warning("No data for visibility")
